...
namespace Binarysharp.MemoryManagement.Native
{
    ...
    public static class NativeMethods
    {
        ...
        [DllImport("ntdll.dll")]
        public static extern unsafe uint NtQueryInformationThread(SafeMemoryHandle handle,
            ThreadInformationClass threadInformationClass, void* threadInformation, IntPtr threadInformationLength,
